...
class Userprofile(AbstractUser):
    ...
    nick_name = models.CharField(verbose_name="用户昵称",max_length=50,default="")
    birday = models.DateField(verbose_name="用户生日",null=True,blank=True)
    gender = models.CharField(verbose_name="性别",max_length=6,choices=GENDER_CHOICE,default="female")
